...
describe('Boggle Solver tests suite:', () => {
  describe('Normal input', () => {
    test('normal gridn 4x4', () => {
      let grid = [['L', 'W', 'B', 'H'],
                 ...
                 ['V', 'M', 'T', 'U'],
                 ['S', 'E', 'N', 'D']];
      let dictionary = ['sad', 'bag', 'cat', 'mail', 'love', 'mat', 'bat', 
                       'rat', 'tag', 'lit', 'hat', 'has', 'had', 'end', 'send'];
      let expected = ['bag', 'mail', 'love', 'mat', 'bat', 'tag', 'lit', 'hat',
                     'end', 'send'];
  ...
  describe('Problem constraints', () => {
    test('grid containing Qu', () => {
      ...
      let expected = ['ten','wet', 'went', 'ego', 'net', 'new', 'newt', 'pry', 'prat', 
  ...
  describe('Input edge cases', () => {
    ...
    test('Grid is empty', () => {
      let grid = [[ ]];
      let dictionary = ['art', 'ego', 'gent', 'grid', 'get', 'net', 'new',
                    'pry', 'qua', 'quart', 'quartz', 'rat', 'tar', 'tarp',
                    'ten', 'went', 'wet', 'arty', 'egg', 'not', 'quar'];
      let expected = [];
      let solutions = boggle_solver.findAllSolutions(grid, dictionary);
    ...
    test('uppercase dictionary with lowercase grid', () => {
      let grid = [['t', 'w', 'y', 'r'],
              ...
              ['o', 'n', 't', 'a']];
      let dictionary = ['ART', 'EGO', 'GENT', 'GET', 'NET', 'NEW', 'NEWT', 'PRAT',
                       'QUART', 'TEN', 'WENT', 'ARTY', 'EGG', 'NOT', 'QUAR'];
      let expected = ['ten', 'went', 'ego', 'net', 'new', 'newt',  'prat', 
        'get', 'gent',  'quar', 'quart', 'art']; 
      let solutions = boggle_solver.findAllSolutions(grid, dictionary);
      expect(solutions.sort()).toEqual(expected.sort());
    });
